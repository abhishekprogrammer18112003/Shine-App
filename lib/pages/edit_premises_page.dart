...
class EditPremisesPage extends StatefulWidget {
  dynamic premises;
  ...
  @override
  State<EditPremisesPage> createState() => _EditPremisesPageState();
}

class _EditPremisesPageState extends State<EditPremisesPage> {
